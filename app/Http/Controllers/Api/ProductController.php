...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Size filter (through variants JSON attributes)
    ...
    /**
     * Get available filters for product catalog
     */
    ...
    /**
     * Get available attributes for a product (sizes, colors, etc.)
     */
